...
async function createFiltro(req, res) {
  try {
    const { body } = req;
    const [filtro, error] = await FiltroService.createFiltro(body);
...
async function updateFiltro(req, res) {
  try {
    ...
    const [updatedFiltro, error] = await FiltroService.updateFiltro(params.id, body);
...
async function deleteFiltro(req, res) {
  try {
    const { params } = req;
    const [deletedFiltro, error] = await FiltroService.deleteFiltro(params.id);
